...
const App = () => {
  ...
  let [type, setTypeSearch] = useState("");
  ...
  let api = `https://periclim-api.herokuapp.com/documents?q=${search}&_limit=${limitPerPage}&_page=${pageNumber}&_sort=publication_year&_order=desc${yearString}${languageString}${typeString}`;
  useEffect(() => {
    (async function () {
